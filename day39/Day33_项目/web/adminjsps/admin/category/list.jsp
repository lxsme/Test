...
<style type="text/css">
  ...
  <c:if test="${sessionScope.categories ==null}">
	  ...
	  <h2 style="text-align: center;">还没有分类</h2>
...
<c:forEach items="${sessionScope.categories}" var="categories">
	<tr bordercolor="rgb(78,78,78)">
		<td>${categories.cname}</td>
		<td>
			<a href="<c:url value='/adminCategory?method=showDelete&cid=${categories.cid}&chose=1'/>">修改</a> |
			<a href="<c:url value='/adminCategory?method=showDelete&cid=${categories.cid}&chose=2'/>">删除</a>
		</td>
	</tr>
</c:forEach>
