...
public class UserService {
    ...
    public MimeMessage sendMail(String to, String code) throws MessagingException {
        ...
        String url="http://localhost:8080/active.action?code=" + code + "&method=active";
        System.out.println(url);



        msg.setContent("<h1>此邮件为官方激活邮件！请点击下面链接完成激活操作！</h1><h3><a href='http://localhost:8080/active.action?method=active&code=" + code + "'>点此激活</a>" +
