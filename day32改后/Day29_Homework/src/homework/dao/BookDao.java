...
//        System.out.println(books);
    ...
    public  Book queryBeanByBname(String bname) throws SQLException {
    ...
    public void insert(Book book) throws SQLException {
        ...
        String sql = "insert into book (bid,bname,author,price,path)value(null,?,?,?,?)";
        Connection conn = JdbcUtil.getConnection();
        new WhQueryRunner().update(conn,sql,book.getBname(),book.getAuthor(),book.getPrice(),book.getPath());
